...
export const InfoModal = ({isOpen, handleClose}: Props) => {
  return (
    <BaseModal title='How to play' isOpen={isOpen} handleClose={handleClose}>
      ...
      <p className='text-sm text-gray-500 dark:text-gray-300'>The letter W is in the word and in the correct spot.</p>
      ...
      <p className='text-sm text-gray-500 dark:text-gray-300'>The letter L is in the word but in the wrong spot.</p>
      ...
      <p className='text-sm text-gray-500 dark:text-gray-300'>The letter U is not in the word in any spot.</p>
